...
def guess_was_right(player_guess, element1, element2):
    return (element1["follower_count"] > element2["follower_count"] and player_guess == 'a') or (
        element2["follower_count"] > element1["follower_count"] and player_guess == 'b')
...
while not game_is_over:
    ...
    while element2 == None or element2 is element1:
